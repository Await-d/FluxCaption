...
class ASRRequest(BaseModel):
    ...
    language: str | None = Field(None, description="Source language code (None for auto-detect)")
    ...
    translate_to: list[str] | None = Field(None, description="Target languages for translation")
    mt_model: str | None = Field(None, description="Translation model to use")
...
class ASRSegmentRequest(BaseModel):
    ...
    language: str | None = Field(None, description="Source language")
...
class TranscriptionSegment(BaseModel):
    ...
    no_speech_prob: float | None = Field(None, description="No speech probability")
...
class TranscriptionInfo(BaseModel):
    ...
    duration_after_vad: float | None = Field(None, description="Duration after VAD filtering")
