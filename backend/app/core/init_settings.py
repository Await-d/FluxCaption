...
CONFIG_CONSTRAINTS: dict[str, dict[str, Any]] = {
    ...
    "translation_line_concurrency": {
        ...
        "step": 1,
        "unit": "requests",
        "description_suffix": "Must be between 1 and 20 concurrent requests",
    },
    "ai_provider_max_concurrency": {
        ...
        "step": 1,
        "unit": "requests",
        "description_suffix": "Must be between 1 and 50 concurrent requests",
    },
...
def init_system_settings(db: Session) -> None:
    ...
    default_settings = [
        ...
        {
            "key": "translation_line_concurrency",
            "value": str(config.translation_line_concurrency),
            "description": "Maximum concurrent upstream translation requests per subtitle batch. Higher values improve throughput but may overload cloud providers.",
            "category": "translation",
            "is_editable": True,
            "value_type": "int",
        },
        {
            "key": "ai_provider_max_concurrency",
            "value": str(config.ai_provider_max_concurrency),
            "description": "Maximum concurrent upstream AI requests allowed per provider within a single backend process.",
            "category": "translation",
            "is_editable": True,
            "value_type": "int",
        },
        ...
        {
            "key": "ai_models_auto_sync_enabled",
            "value": str(config.ai_models_auto_sync_enabled),
            "description": "Enable automatic AI model catalog sync in the background.",
            "category": "ai_models",
            "is_editable": True,
            "value_type": "bool",
        },
        {
            "key": "ai_models_auto_sync_interval_seconds",
            "value": str(config.ai_models_auto_sync_interval_seconds),
            "description": "Interval in seconds between automatic AI model catalog sync runs.",
            "category": "ai_models",
            "is_editable": True,
            "value_type": "int",
        },
        {
            "key": "ai_models_catalog_url",
            "value": str(config.ai_models_catalog_url),
            "description": "Base URL of the opencode-compatible AI model catalog source.",
            "category": "ai_models",
            "is_editable": True,
            "value_type": "string",
        },
